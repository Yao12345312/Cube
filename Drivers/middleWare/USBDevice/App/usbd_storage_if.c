...
/* USER CODE BEGIN PV */
/* Private variables ---------------------------------------------------------*/
static BSP_SD_CardInfo sd_card_info;
static int8_t sd_initialized = 0;
/* USER CODE END PV */
...
#define STORAGE_SD_TIMEOUT               10000
...
int8_t STORAGE_GetCapacity_FS(uint8_t lun, uint32_t *block_num, uint16_t *block_size)
{
  ...
  BSP_SD_GetCardInfo(&sd_card_info);
  *block_num  = sd_card_info.LogBlockNbr;
  *block_size = (uint16_t)sd_card_info.LogBlockSize;
  return (USBD_OK);
  /* USER CODE END 3 */
}
