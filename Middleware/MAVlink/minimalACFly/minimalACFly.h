...
#define MAVLINK_MINIMALACFLY_XML_HASH -5118292197955360605
...
typedef enum MAV_COMPONENT
{
   ...
   MAV_COMP_ID_CAMERA_SkyDroid_2_Axis=106, /* Camera #5. | */
   MAV_COMP_ID_CAMERA_SkyDroid_3_Axis=107, /* Camera #5. | */
   MAV_COMP_ID_CAMERA_NEXTVISION=108, /* Camera #5. | */
   MAV_COMP_ID_HYDROGEN_BATTERY=139, /* Camera #5. | */
...
#if MAVLINK_MINIMALACFLY_XML_HASH == MAVLINK_PRIMARY_XML_HASH
