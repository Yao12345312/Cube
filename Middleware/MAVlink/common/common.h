...
#define MAVLINK_COMMON_XML_HASH 5412318541432904064
...
typedef enum HIL_SENSOR_UPDATED_FLAGS
{
   ...
   HIL_SENSOR_UPDATED_RESET= (int)2147483649u, /* Full reset of attitude/position/velocities/etc was performed in sim (Bit 31). | */
