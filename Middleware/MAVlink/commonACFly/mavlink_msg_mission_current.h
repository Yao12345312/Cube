...
{
    return mavlink_msg_mission_current_pack_status(system_id, component_id, _status, msg,  mission_current->seq, mission_current->resumeSeq, mission_current->flag, mission_current->heading, mission_current->vector_x, mission_current->vector_y, mission_current->vector_z, mission_current->distance, mission_current->trigger_interval, mission_current->speed, mission_current->radius);
}
